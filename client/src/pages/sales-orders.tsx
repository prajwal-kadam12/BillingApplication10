      ...
      <div className="flex items-center gap-2 px-6 py-3 bg-white border-b border-sidebar/10 overflow-x-auto flex-wrap scrollbar-hide">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="ghost" size="sm" className="h-8 gap-1.5 text-sidebar font-bold font-display hover:bg-sidebar/5" data-testid="button-convert-invoice">
          ...
          <DropdownMenuContent align="start" className="w-56 font-display">
            <DropdownMenuItem onClick={onConvertToInvoice} className="font-medium" data-testid="menu-item-invoice-all">
              <Receipt className="mr-2 h-4 w-4 opacity-70" /> Invoice All Items
            </DropdownMenuItem>
            <DropdownMenuItem onClick={onConvertSelectedItems} className="font-medium" data-testid="menu-item-invoice-selected">
