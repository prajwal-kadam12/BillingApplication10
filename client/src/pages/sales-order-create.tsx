...
export default function SalesOrderCreatePage() {
  ...
  const handleItemChange = (index: number, itemId: string) => {
    ...
    if (itemId === "__add_new_item__") {
      setLocation("/products/new?returnTo=sales-orders/create");
      return;
    }
    if (item) {
                          ...
                          <td className="px-6 py-4">
                            <Select value={item.itemId} onValueChange={(v) => handleItemChange(index, v)}>
                              ...
                              <SelectContent>
                                ...
                                <Separator key="sep" className="my-1" />
                                <SelectItem value="__add_new_item__" className="text-blue-600 font-medium">
